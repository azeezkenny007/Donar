...
const Button = ({ children, variant }: Props) => {
  ...
  return (
    <button
      className="
       px-4 md:px-6 py-2 w-full md:py-4 text-center rounded-md font-semibold text-sm md:text-text text-dark-primary bg-gradient-to-br from-dark-accent  to-dark-accent2">
      {children}
    </button>
  );
};
